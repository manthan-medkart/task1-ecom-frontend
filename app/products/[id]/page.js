          ...
          <div className="border border-zinc-900 bg-zinc-950/20 p-5 rounded-2xl space-y-4">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              ...
              <button
                ...
                className={`w-full flex items-center justify-center gap-2 font-semibold py-3 px-6 rounded-xl shadow-lg transition-all ${isOutOfStock
              ...
              <div key={rev.id} className="border border-zinc-900 bg-zinc-950/20 p-5 rounded-xl space-y-3">
                ...
                <div className="flex items-center gap-0.5">
                  {[...Array(5)].map((_, i) => (
                    <Star
                      key={i}
                      className={`h-3.5 w-3.5 ${i < rev.rating ? 'fill-amber-400 text-amber-400' : 'text-zinc-850'
                        }`}
                    />
                  ))}
                </div>
